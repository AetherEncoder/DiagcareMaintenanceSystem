    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            Using conn As New MySqlConnection(_connectionString)
                ...
                Dim sql As String = "INSERT INTO medtech (MedtechID, LicenseNo, FirstName, LastName, PhoneNumber) " &
                                    "VALUES (@MedtechID, @LicenseNo, @FirstName, @LastName, @PhoneNumber)"
            ...
            MessageBox.Show("MedTech added successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub LoadNextMedTechId()
        ...
        Try
            Using conn As New MySqlConnection(_connectionString)
                ...
                Dim newMedTechId As Integer = GetNextAvailableMedTechId(conn)
                If newMedTechId = -1 Then
                    txtMedTechID.Text = ""
                    MessageBox.Show("No available MedTechID in range 60001 to 69999.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Return
                End If

                txtMedTechID.Text = newMedTechId.ToString()
            End Using
        Catch ex As Exception
            txtMedTechID.Text = ""
